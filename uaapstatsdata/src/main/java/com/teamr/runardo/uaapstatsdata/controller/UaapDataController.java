...
public class UaapDataController {
    ...
    @GetMapping("/fetch/uaapstats")
    public ResponseEntity<List<? extends PlayerStat>> fetchUaapStats(@RequestParam String code) {
        List<? extends PlayerStat> uaapStats = uaapDataService.findUaapStats(code);
